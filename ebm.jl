...
Cd_slider = @bind Cd Slider(
	max(Int(round(phys.Cd-2*cmip5_std["Cd"], digits=0)), 5)
...
[[deps.ClimateMARGO]]
deps = ["CompilerSupportLibraries_jll", "DiffResults", "DiffRules", "ForwardDiff", "Ipopt", "Ipopt_jll", "JSON2", "JuMP", "PyPlot", "Revise"]
git-tree-sha1 = "55de420f787580bfcdf5426b6ee3b3044a6d5d9f"
